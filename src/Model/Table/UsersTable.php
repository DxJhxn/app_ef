...
class UsersTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->email('correo', false, 'Debe ingresar un correo válido.')
            ->add('correo', 'unique', ['rule' => 'validateUnique', 'provider' => 'table', 'message' => 'Este correo ya está registrado.']);
